...
export default function ShuttlecockIcon({
  ...
  return (
    ...
    >
      ...
      {/* Feathers */}
      <path d = "M9 18 L8 8 L10 6 L12 8 Z" fill = "currentColor" opacity = "0.6"
      />
      <path d = "M12 18 L11 6 L12 4 L13 6 Z" fill = "currentColor" opacity = "0.8"
      />
      <path d = "M15 18 L16 8 L14 6 L12 8 Z" fill = "currentColor" opacity = "0.6"
      />
