      ...
      <div className = "max-w-2xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className = "bg-card border-2 border-border rounded-3xl p-8 md:p-10 shadow-sm">
          ...
          <div className = "space-y-4">
            <Button onClick = {handleCheckIn} className = "w-full rounded-2xl h-auto p-7 shadow-lg shadow-primary/20" size = "lg"
            >
            ...
            <Link to = {`/sessions/${sessionId}/late`} className = "block">
              <Button variant = "outline" className = "w-full rounded-2xl h-auto p-6 border-2" size = "lg"
              >
                <div className = "flex items-center gap-4 w-full">
            ...
            <Button variant = "outline" className = "w-full rounded-2xl h-auto p-6 border-2 border-destructive/30 hover:bg-destructive/5" size = "lg" onClick = {() => {
