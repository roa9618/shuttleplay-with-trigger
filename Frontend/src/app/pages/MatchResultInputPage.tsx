          ...
          <div className="border-t border-border pt-6 space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  variant="outline"
                  className={`h-auto py-4 rounded-xl border-2 hover:border-primary hover:bg-primary/5 ${winner === 'A' ? 'border-primary bg-primary/5' : ''}`}
                  onClick={() => setWinner('A')}
                >
                  A팀 승리
                </Button>
                <Button
                  variant="outline"
                  className={`h-auto py-4 rounded-xl border-2 hover:border-primary hover:bg-primary/5 ${winner === 'B' ? 'border-primary bg-primary/5' : ''}`}
                  onClick={() => setWinner('B')}
                >
                  B팀 승리
                </Button>
            ...
            <div className="pt-4 space-y-3">
              ...
              <Button
                ...
                size="lg"
                disabled={!winner}
                onClick={() => showMessage(`${winner}팀 승리로 저장했습니다.`)}
              >
                결과 저장
              </Button>
