            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, allowGuestJoin: checked })}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, autoApproveMembers: checked })}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, requireSkillLevel: checked })}
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({ ...formData, defaultSessionType: value })}
                >
              ...
              <div className="space-y-2">
                <Label>기본 코트 수</Label>
                <Select
                  value={formData.defaultCourts}
                  onValueChange={(value) => setFormData({ ...formData, defaultCourts: value })}
                >
                  <SelectTrigger className="rounded-xl">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formData.defaultMatchType}
                  onValueChange={(value) => setFormData({ ...formData, defaultMatchType: value })}
                >
                  <SelectTrigger className="rounded-xl">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formData.defaultPlayStyle}
                  onValueChange={(value) => setFormData({ ...formData, defaultPlayStyle: value })}
                >
                  <SelectTrigger className="rounded-xl">
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={key} className="flex items-center justify-between rounded-2xl border border-border p-5">
                  ...
                  <Switch
                    checked={formData[key as 'protectNewPlayers' | 'avoidDuplicatePartners' | 'useFlexibleGender']}
