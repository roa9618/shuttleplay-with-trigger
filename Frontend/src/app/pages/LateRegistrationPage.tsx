      ...
      <div className = "max-w-md mx-auto px-4 pb-12 space-y-8">
        ...
        <div className = "bg-card border border-border rounded-3xl p-8 space-y-6">
          <div>
            ...
            <div className = "grid grid-cols-2 gap-3">
              {quickOptions.map((option) => (
                <Button key = {option.value} type = "button" variant = "outline" size = "default" onClick = {() => setSelectedMinutes(option.value)} className = {`rounded-full h-auto py-4 ${
          ...
          <div className = "space-y-2">
            ...
            <Textarea id = "reason" placeholder = "간단히 사유를 입력해주세요" className = "rounded-xl resize-none" rows = {3} value = {reason} onChange = {(e) => setReason(e.target.value)}
            />
