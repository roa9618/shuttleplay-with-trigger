        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => showMessage('자동 매칭 후보를 다시 생성했습니다.')}
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {['강제 포함', '강제 제외', '고정 파트너', '회피 조합'].map((label) => (
                <Button
                  key={label}
                  variant="outline"
                  className={`rounded-xl justify-start gap-2 h-12 ${selectedAdjustments.includes(label) ? 'border-primary bg-primary/5' : ''}`}
                  onClick={() => {
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="flex flex-col gap-3 ml-6">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="rounded-full gap-2"
                    onClick={() => showMessage(`후보 ${idx + 1} 참가자 교체 모드를 열었습니다.`)}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    className="rounded-full gap-2"
                    onClick={() => showMessage(`후보 ${idx + 1}의 A/B팀을 교체했습니다.`)}
                  >
                    팀 교체
                  </Button>
                  <Button
                    ...
                    size="sm"
                    className="rounded-full gap-2"
                    onClick={() => showMessage(`후보 ${idx + 1}을 재생성했습니다.`)}
                  >
                    <RefreshCw className="w-4 h-4" />
                    재생성
                  </Button>
        ...
        {queue.length === 0 && (
          <div className="bg-secondary rounded-2xl p-12 text-center">
            ...
            <Button
              className="rounded-full gap-2"
              onClick={() => showMessage('자동 매칭 후보를 생성했습니다.')}
            >
              <Sparkles className="w-4 h-4" />
              자동 매칭 생성
            </Button>
