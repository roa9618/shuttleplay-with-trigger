        ...
        <div className="bg-card border border-border rounded-3xl p-8 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              onClick={() => navigate('/sessions/demo/report')}
            >
              전체 보기
            </Button>
          </div>
          <div className="grid gap-3">
            {recentSessions.map((session, idx) => (
              <div
                key={idx}
                onClick={() => navigate('/sessions/demo/report')}
                className="bg-gradient-to-r from-secondary/50 to-transparent rounded-2xl p-5 border border-border hover:border-primary transition-all group cursor-pointer"
              >
                <div className="flex items-center justify-between">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {members.map((member, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-r from-secondary/50 to-transparent rounded-2xl p-5 border border-border hover:border-primary transition-all"
              >
                <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  onClick={() => showMessage('초대 QR 코드를 준비했습니다.')}
                >
