              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFormData({ ...formData, courts: value })}
                  >
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="rounded-2xl border border-border p-5 flex items-center justify-between">
                    ...
                    <Switch
                      checked={formData.quickAddMembers}
                      onCheckedChange={(checked) => setFormData({ ...formData, quickAddMembers: checked })}
                    />
                  </div>
