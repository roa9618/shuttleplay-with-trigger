            ...
            <div>
              ...
              <div className = "space-y-6">
                <div className = "space-y-2">
                  ...
                  <Input id = "name" type = "text" placeholder = "예: 강남 배드민턴 클럽" className = "rounded-xl h-12" value = {formData.name} onChange = {(e) => setFormData({ ...formData, name: e.target.value })}
                    required
                  />
                ...
                <div className = "space-y-2">
                  ...
                  <div className = "relative">
                    ...
                    <Input id = "location" type = "text" placeholder = "예: 강남구민회관" className = "rounded-xl h-12 pl-11" value = {formData.location} onChange = {(e) => setFormData({ ...formData, location: e.target.value })}
                      required
                    />
                  </div>
                  <p className = "text-sm text-muted-foreground">
                ...
                <div className = "space-y-2">
                  ...
                  <Textarea id = "description" placeholder = "모임의 분위기나 특징을 자유롭게 소개해주세요" className = "rounded-xl resize-none" rows = {4} value = {formData.description} onChange = {(e) => setFormData({ ...formData, description: e.target.value })}
                  />
                </div>
              </div>
            </div>
              ...
              <div className = "space-y-6">
                <div className = "space-y-2">
                  ...
                  <div className = "relative">
                    ...
                    <Input id = "defaultTime" type = "text" placeholder = "예: 화요일, 목요일 19:00 - 21:00" className = "rounded-xl h-12 pl-11" value = {formData.defaultTime} onChange = {(e) => setFormData({ ...formData, defaultTime: e.target.value })}
                    />
                  </div>
                  <p className = "text-sm text-muted-foreground">
