...
export default function GalleryPage() {
  const desktopPages = [
    ...
    { name: '모임 상세 홈', path: '/groups/1', description: '모임 요약, 다가오는 일정, 최근 기록 및 활동 통계' },
    { name: '모임 일정', path: '/groups/1/schedule', description: '캘린더와 날짜별 운동 일정 관리' },
    { name: '모임 게시판', path: '/groups/1/board', description: '공지사항과 자유 게시판 관리' },
    { name: '모임 멤버', path: '/groups/1/members', description: '멤버 통계와 권한 관리' },
    { name: '모임 가입 요청', path: '/groups/1/requests', description: '신규 회원 가입 요청 승인 및 거절' },
  ...
  const mobilePages = [
    ...
    { name: '새 비밀번호 설정', path: '/password-reset/confirm', description: '모바일 새 비밀번호 입력' },
